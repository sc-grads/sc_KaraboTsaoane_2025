...
insert into tblEmployees(EmployeeNumber, EmployeeFirstName, EmployeeMiddleName, EmployeeLastName, 
...
delete from tblEmployee2  --When you delete and insert again the numbering continues

truncate table tblEmployee2  --When you truncate the numbers start from 1 again
